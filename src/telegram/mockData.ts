...
const messages: Message[] = [
  ...
  },
  {
    ...
    sentAt: "2026-08-01T09:48:10+08:00",
    delivery: "read",
    interaction: { viewCount: 22_200, forwardCount: 23, replyCount: 2, reactions: [], hasDiscussion: true },
    content: { kind: "text", text: "Release Notes channel posted this reply" },
  },
  {
    ...
    senderId: "u-mia",
    outgoing: false,
    sentAt: "2026-08-01T09:49:10+08:00",
    delivery: "read",
    replyTo: {
      kind: "message",
      chatId: "chat-release",
    ...
    content: { kind: "text", text: "这个版本的桌面端体验顺滑了很多。" },
  },
  {
    id: "release-comment-2",
    chatId: "chat-release",
    senderId: "self",
    outgoing: true,
    sentAt: "2026-08-01T09:50:02+08:00",
    delivery: "read",
    replyTo: {
      kind: "message",
      chatId: "chat-release",
    ...
    content: { kind: "text", text: "谢谢反馈，我们会继续收集问题。" },
  },
  {
    id: "forum-general-1",
    chatId: "chat-forum",
